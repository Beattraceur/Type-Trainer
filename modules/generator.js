...
export function generateArena(){ ///generates Template for typequest
...
export function generateQuestArr(){ /// generates quest array depending on the global level
...
export function generateActiveKeyArr(questArr){ /// generates a second array with key information corresponding to the quest array
let activeKeyArr = [];
...
export function displayLineChart(data,containerElement){ /// generates linechart with chart js
  el(`#${containerElement}`).innerHTML = `<div id="canvasholder"><canvas id = "canvas"></canvas></div>`;
